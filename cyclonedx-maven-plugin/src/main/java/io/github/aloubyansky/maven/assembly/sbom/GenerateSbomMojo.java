 ...
 * {@code embeddedSbomHandling} parameter. Additional external
 * SBOMs (e.g., an npm SBOM) can be merged via {@code mergeBoms}.
 * </p>
 */
@Mojo(name = "generate-sbom", defaultPhase = LifecyclePhase.PREPARE_PACKAGE, requiresDependencyResolution = ResolutionScope.RUNTIME)
public class GenerateSbomMojo extends AbstractMojo {
    ...
    private String embeddedSbomHandling;
    ...
    public void execute() throws MojoExecutionException {
        ...
        List<Bom> externalBomList = SbomGenerator.parseExternalBoms(
                mergeBoms, project.getBasedir().toPath());
